---
description: Find and prove the root cause of a bug
---
...
1. **Debug** — identify the most likely cause of the bug
2. **Prove** — Write a unit test (follow `docs/testing.md`) that proves the issue
3. **Run** — Execute the test to confirm your hypothesis

If the test doesn't prove you are correct with the cause — continue with your investigation until you find AND PROVE the root cause.
